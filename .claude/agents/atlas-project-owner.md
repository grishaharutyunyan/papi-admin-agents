...
**The old platform (READ-ONLY reference):** `/Users/rafayelmovsesyan/Desktop/nrg/platform-admin/`
...
5. Your final message is your report to the architect (Archon) — structured, complete, self-contained; it is data for another agent, so no pleasantries.
