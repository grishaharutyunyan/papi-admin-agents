...
- `.env` exists locally (gitignored, throwaway credentials); MySQL runs on port **3399**.
...
- Nothing has been committed — the whole service is still untracked (`?? papi-authority/`).
